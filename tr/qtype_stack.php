...
/**
 * Strings for component 'qtype_stack', language 'tr', version '4.5'.
 *
 * @package     qtype_stack
 * @category    string
...
$string['expectedoutcomes'] = 'Beklenen PRT sonuçları: [kullanılan girdiler]';
$string['exportthisquestion'] = 'Bu soruyu dışa aktar';
$string['false'] = 'Yanlış';
$string['falsebranch'] = 'Yanlış dal';
$string['feedbackstyle_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Potential_response_trees.md';
$string['feedbackvariables_help'] = 'Geri bildirim değişkenleri, ağacı geçmeden önce soru değişkenleriyle birlikte girdilerden herhangi birini değiştirmenizi sağlar.  Burada tanımlanan değişkenler bu ağacın başka herhangi bir yerinde kullanılabilir.';
...
$string['healthchecksampleplots'] = 'Aşağıda iki örnek grafik bulunmaktadır.  {@plot([x^4/(1+x^4),diff(x^4/(1+x^4),x)],[x,-3,3])@} {@plot([sin(x),x,x^2,x^3],[x,-3,3],[y,-3,3],grid2d)@}  Üçüncü, daha küçük bir çizim, geleneksel eksenlerle aşağıda görüntülenmelidir. {@plot([x,2*x^2-1,x*(4*x^2-3),8*x^4-8*x^2+1,x*(16*x^4-20*x^2+5),(2*x^2-1)*(16*x^4-16*x^2+1)],[x,-1,1],[y,-1. 2,1.2],[box, false],[yx_ratio, 1],[axes, solid],[xtics, -3, 1, 3],[ytics, -3, 1, 3],[size,250,250])@}';
$string['illegalcaschars'] = 'CAS girişinde @, $ ve \\ karakterlerine izin verilmez.';
$string['inputextraoptions_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Extra options';
$string['inputstatusnamescore'] = 'Puan';
$string['inputtype_help'] = 'Bu, giriş öğesinin türünü belirler, örneğin form alanı, doğru/yanlış, metin alanı.';
$string['inputtype_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md';
$string['inputtypeboolean'] = 'Doğru/yanlış';
$string['insertspaces'] = 'Yalnızca boşluklar için yıldız ekleyin';
$string['insertstars'] = 'Yıldız ekle';
$string['insertstars_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Inputs.md#Insert_Stars';
$string['insertstarsassumesinglechar'] = 'Tek karakterli değişken adlarını varsayarak yıldızları ekleyin';
$string['insertstarsspaces'] = 'Örtülü çarpma ve boşluklar için yıldız ekleyin';
$string['insertstarsspacessinglechar'] = 'Tek karakterli değişkenleri varsayarak, ima edilen ve boşluklar için yıldızları ekleyin';
$string['insertstarsyes'] = 'Yalnızca ima edilen çarpma için yıldız ekleyin';
...
$string['nodexfalsefeedback'] = 'Düğüm {$a} yanlış geri bildirim';
$string['nodexwhenfalse'] = 'Düğüm {$a} yanlış olduğunda';
$string['penalty_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Feedback.md';
$string['privacy:metadata'] = 'STACK soru tipi eklentisi herhangi bir kişisel veri saklamaz.';
...
$string['replacedollarsindex'] = 'STACK soruları içeren bağlamlar';
...
$string['showvalidationcompact'] = 'Evet, kompakt yapıda';
$string['showvalidationyes'] = 'Evet, değişken listesiyle';
$string['showvalidationyesnovars'] = 'Evet, değişken listesi olmadan';
$string['sqrtsign_link'] = '%%WWWROOT%%/question/type/stack/doc/doc.php/Authoring/Options.md#surd';
$string['stackDoc_AnswerTestResults'] = '# Cevap testi sonuçları

 Bu sayfa, STACK test durumlarında yanıt testlerinin çalıştırılmasının sonuçlarını gösterir.  Bu sayfa STACK birim testlerinden otomatik olarak oluşturulur ve soru yazarlarına cevap testlerinin gerçekte ne yaptığını göstermek için tasarlanmıştır.  Bu, cevap testlerinin geçerli olarak başarısız olduğu ve olumsuz bir beklenen not verdiği durumları içerir.  Yorumlar ve daha fazla test durumu memnuniyetle karşılanır.';
