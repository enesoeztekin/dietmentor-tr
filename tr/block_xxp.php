...
/**
 * Strings for component 'block_xxp', language 'tr', version '4.5'.
 *
 * @package     block_xxp
 * @category    string
...
$string['configdescription'] = 'Eklenecek açıklama';
...
$string['enablexpgain'] = 'XP kazanmayı etkinleştir';
$string['enablexpgain_help'] = 'Bu, bu kurstaki eklentinin Açma/Kapama anahtarıdır.';
$string['errorlevelsincorrect'] = 'Minimum seviye sayısı 2\'dir.';
$string['event_user_leveledup'] = 'Kullanıcı seviye atladı';
$string['eventname'] = 'Etkinlik ismi';
...
$string['pluginname'] = 'Seviye atla!';
$string['progress'] = 'İlerle';
$string['reallyresetdata'] = 'Bu kurstaki herkesin seviyelerini ve deneyim puanlarını gerçekten sıfırladınız mı?';
$string['resetcoursedata'] = 'Kurs verilerini sıfırla';
$string['xp'] = 'Deneyim puanları';
$string['xp:addinstance'] = 'Yeni bir XP bloğu ekle';
$string['xpgaindisabled'] = 'XP kazancı devre dışı bırakıldı';
