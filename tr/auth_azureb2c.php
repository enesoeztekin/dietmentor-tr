...
/**
 * Strings for component 'auth_azureb2c', language 'tr', version '4.5'.
 *
...
$string['cfg_loginflow_authcode_desc'] = 'Bu akışı kullanarak, kullanıcı, Moodle oturum açma sayfasında kimlik sağlayıcının adını tıklar (yukarıdaki "Sağlayıcı Adı"na bakın) ve oturum açması için sağlayıcıya yönlendirilir. Başarılı bir şekilde oturum açtıktan sonra, kullanıcı, Moodle\'a geri yönlendirilir. Moodle girişi şeffaf bir şekilde gerçekleşir.  Bu, kullanıcı oturumu açmanın en standart ve güvenli yoludur.';
$string['cfg_opname_key'] = 'Sağlayıcı Adı';
$string['cfg_userrestrictions_key'] = 'Kullanıcı Kısıtlamaları';
$string['errorauthloginfailednouser'] = 'Geçersiz giriş: Moodle\'da kullanıcı bulunamadı.  Bu sitede "authpreventaccountcreation" ayarı etkinleştirildiyse, bu, önce bir yöneticinin sizin için bir hesap oluşturması gerektiği anlamına gelebilir.';
