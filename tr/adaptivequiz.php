...
$string['score'] = 'Puan';
$string['showabilitymeasure'] = 'Öğrencilere yetenek ölçüsünü göster';
$string['showabilitymeasure_help'] = 'Bazen uyarlamalı bir sınavdan sonra öğrencilere yetenek tahminlerini açıklamak faydalı olabilir. Bu ayar etkinleştirildiğinde, öğrenci deneme özetinde ve bir denemeyi bitirdikten hemen sonra yetenek tahminini görebilir.';
