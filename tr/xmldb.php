...
/**
 * Strings for component 'xmldb', language 'tr', version '4.5'.
 *
 * @package     xmldb
 * @category    string
...
$string['nofieldsspecified'] = 'Alan belirtilmedi';
$string['noreffieldsspecified'] = 'Referans alanı belirtilmedi';
...
$string['wrongnumberofreffields'] = 'Yanlış sayıda referans alanı';
