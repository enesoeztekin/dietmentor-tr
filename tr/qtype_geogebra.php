...
/**
 * Strings for component 'qtype_geogebra', language 'tr', version '4.5'.
 *
...
$string['answervar'] = 'Otomatik not verme için değişkenler';
$string['answervar_help'] = 'Otomatik not vermek için: Öğrenci soruyu (kısmen) çözdüğünde, GeoGebra\'da doğru değeri alan mantıksal nesnenin adı. Mantıksal nesneler için bütün notların toplamı. Eğer herhangi bir kombinasyon %100-ü aşıyorsa soru doğrudur fakat toplamı tam olarak %100 olan en az bir kombinasyon var olmalıdır. El ile notlandırma için boş bırakınız.';
...
$string['pluginnamesummary'] = 'Hesaplanan soruların, soruyu göstermek ve sınav yapıldığında cevabı doğrulamak için GeoGebra kullanan bir versiyonu.';
$string['privacy:metadata'] = 'Geogebra soru tipi eklentisi herhangi bir kişisel veri saklamaz.';
