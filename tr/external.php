...
/**
 * Strings for component 'external', language 'tr', version '4.5'.
 *
 * @package     external
 * @category    string
...
$string['privacy:metadata:serviceusers'] = 'Belirli bir harici hizmeti kullanabilen kullanıcıların listesi';
...
$string['privacy:metadata:serviceusers:validuntil'] = 'Yetkilendirmenin geçerli olduğu tarih';
